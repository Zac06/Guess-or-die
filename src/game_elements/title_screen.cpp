...
bool title_screen::update_render(){
    ...
    if(slides[curr_slide].text_fc!=NULL){
        win.render_text_fc(*(slides[curr_slide].text_fc), slides[curr_slide].text, slides[curr_slide].text_x, slides[curr_slide].text_y, true);
    }
